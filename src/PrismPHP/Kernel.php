...
class Kernel
{
     ...
     *
     * @param string $_env          The application environment (e.g., 'development', 'production').
     * @param string $_configDir    The configuration directory path. Defaults to an empty string, which resolves to
     * the default configuration directory.
     *
     * @return void
     */
    public function __construct(private readonly string $_env, private string $_configDir = '')
    {
